# Build a zip archive of the project for the final audit, excluding build artifacts.
$ErrorActionPreference = "Stop"

$Source = (Get-Location).Path
$Stage = Join-Path $env:TEMP "crypto-market-screener-final-audit-stage"
$ZipPath = Join-Path $Source "crypto-market-screener-final-audit.zip"
